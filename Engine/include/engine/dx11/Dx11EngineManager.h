...
public:
  ...
  void CreateLinearSampler(Microsoft::WRL::ComPtr<ID3D11SamplerState>& samplerBuffer)
  {
  ...
  void CreateClampSampler(Microsoft::WRL::ComPtr<ID3D11SamplerState>& samplerBuffer)
  {
    D3D11_SAMPLER_DESC sampDesc;
    ZeroMemory(&sampDesc, sizeof(sampDesc));
    sampDesc.Filter         = D3D11_FILTER_MIN_MAG_MIP_LINEAR;
